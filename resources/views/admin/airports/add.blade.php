    ...
    <div class="container">
        <div class="row justify-content-center" style="margin-top: 17rem">
            <div class="col-6 d-flex justify-content-between align-items-center">
                <div class="col-9">
                    <h2 style="font-size: 40px;font-weight: 500;color: #265BE3;">Добавление аэропорта</h2>
                </div>
                <div class="col-3">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-6">
                <form action="{{route('AddAirportSave')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <select type="text" class="form-select @error('city_id') is-invalid @enderror" style="height: 45px" name="city_id">
