    ...
    <div class="container">
        <div class="row justify-content-center" style="margin-top: 17rem">
            <div class="col-7 d-flex justify-content-between align-items-center">
                <div class="col-8">
                    <h2 style="font-size: 40px;font-weight: 500;color: #265BE3;">Редактирование города</h2>
                </div>
                <div class="col-4">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-7">
                <form action="{{route('EditCitySave', ['city'=>$city])}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="название" style="height: 45px" name="title" value="{{$city->title}}">
